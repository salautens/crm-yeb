/**
 * BMad Builder Documentation Build Pipeline
 *
...
const REPO_URL = 'https://github.com/bmad-code-org/bmad-builder';
...
// Main Entry Point
/**
 * Orchestrates the full BMad Builder documentation build pipeline.
 *
...
async function main() {
  console.log();
  printBanner('BMad Builder Documentation Build Pipeline');
  console.log();
...
function generateLlmsTxt(outputDir) {
  ...
  const content = [
    ...
    '## Quick Start',
    '',
    `- **[Quick Start](${siteUrl}/tutorials/quick-start)** - Get started with BMad Builder`,
    `- **[Installation](${siteUrl}/reference/installation)** - Installation guide`,
    '',
    '## Core Concepts',
    '',
    `- **[What is BMad Builder?](${siteUrl}/explanation/what-is-builder)** - Understanding the tool`,
    `- **[Creating Agents](${siteUrl}/how-to/create-agent)** - Create custom agents`,
    `- **[Creating Workflows](${siteUrl}/how-to/create-workflow)** - Create custom workflows`,
    '',
    '---',
    '',
    '## Quick Links',
