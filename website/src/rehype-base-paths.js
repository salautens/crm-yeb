 ...
 *
 * Transforms:
 *   /img/foo.png → /bmad-builder/img/foo.png (when base is /bmad-builder/)
 *   /llms.txt → /bmad-builder/llms.txt
 *
 ...
 * @param {string} options.base - The base path to prepend (e.g., '/bmad-builder/')
